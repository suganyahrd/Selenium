...
public class AssignmentSele2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"n-aboutsite\"]/a/span")).click();
		System.out.println(driver.getTitle());

		String ExpectedTitle1 = "Wikipedia:About - Wikipedia";
		String ActualTitle1 = driver.getTitle();
		if (ActualTitle1.equals(ExpectedTitle1)) {
			System.out.println( "Pass the Testcase");
		} else {
			System.out.println("Fail the test cases");
		}
